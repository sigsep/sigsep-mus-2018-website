  ...
  routes: [
    { path: '/', component: App,
      children: [
        ...
        { path: 'results', redirect: { name: 'results', params: {target_id: '4', metric_id: '2' } } },
        { path: 'results/:target_id/:metric_id', name: 'results', component: Results },
        { path: 'results/:target_id/:metric_id/play/:track_id/:method', name: 'player', component: Results },
